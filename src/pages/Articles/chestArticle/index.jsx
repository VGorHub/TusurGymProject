export const ChestOutdoorArticlePage = () => {
    return (
...
export const ChestHomeArticlePage = () => {
    return (
...
export const ChestGymArticlePage = () => {
    return (
        

            <div className="backgroundDiv">
                <div className="centerDiv">
                    <h1 className="articleHeader">Упражнения на Грудь В Зале</h1>
                </div>
            </div>
